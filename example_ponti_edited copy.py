...
class HpoMlp(BaseTestProblem):
    ...
    def __init__(self):
        ...
        # self.config = RobertaConfig.from_pretrained(args.model_name_or_path, num_labels=num_labels)
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with torch.no_grad():
                ...
                for k in range(args.sample_size):
                    prompts_discrete_indices = prompts_dist.sample() # tensor([194, 122, 122,  92, 108,  71,  63, 151,  21,  49])
